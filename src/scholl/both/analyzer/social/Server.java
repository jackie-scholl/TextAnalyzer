 ...
 * An HTTP server.
 * 
 * WARNING: Considered highly dangerous. Not ready for production use. To be honest, not ready for development use.
 * 
...
public class Server extends Thread {
    ...
    public String handleRequest() throws IOException {
        ...
        out.printf("A simple HTTP server, used for OAuth callback.%n%n");
        out.printf("Trying to bind to localhost on port %d...", port);
        
        serversocket = new ServerSocket(port);
        
        out.printf("OK!%nReady, Waiting for requests...%n");
    ...
    private String getOauthVerifier(BufferedReader input, DataOutputStream output) throws IOException {
        ...
        print.printf("Verifier: %s%n", verifier);
        print.close();
...
@Override
    public void run() {
        ...
        try {
            ...
            // Prepare a output stream from to the client,
            // this will be used sending back our response to the client.
            DataOutputStream output = new DataOutputStream(connectionsocket.getOutputStream());

            getOauthVerifier(input, output);
